...
source "$OSH/themes/powerline-multiline2/powerline-multiline2.base.sh"
...
THEME_CLOCK_FORMAT=${THEME_CLOCK_FORMAT:="%a %d %b - %H:%M:%S"}
#THEME_CLOCK_FORMAT=${THEME_CLOCK_FORMAT:="%c"}
